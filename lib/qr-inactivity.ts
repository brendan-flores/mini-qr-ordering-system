/** End QR ordering session after this many minutes without activity (live server). */
export const QR_ORDER_INACTIVITY_MINUTES = 15;
...
export const QR_ORDER_INACTIVITY_MESSAGE =
  "Your ordering session ended after 15 minutes of inactivity. Scan your table QR code again to order.";
