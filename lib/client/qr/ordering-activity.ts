import { isOrderingInactivitySuspended } from "@/lib/client/qr/ordering-inactivity-suspend-state";
import { QR_ORDER_INACTIVITY_MS } from "@/lib/client/qr/qr-inactivity";
