...
export function mysqlConfigError(): string {
  return "MySQL is not configured. Set MYSQL_HOST, MYSQL_USER, MYSQL_PASSWORD, and MYSQL_DATABASE (or Railway MYSQLHOST, MYSQLUSER, …), then run database/schema.sql.";
}
