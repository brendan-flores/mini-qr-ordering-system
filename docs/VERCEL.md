...
Configure a hosted **MySQL** instance and set the `MYSQL_*` variables in Vercel. Run `database/schema.sql` against that database before going live. Step-by-step for **Railway**: [RAILWAY.md](./RAILWAY.md).
